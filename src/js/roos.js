	...
	if (searchPhrase5 == '') {
		...
		$.get('https://www.googleapis.com/customsearch/v1/', { 'cx': cx, 'q': searchString5, 'start': start, 'key': 'AIzaSyAX2BF1-AFcEvBG6YPZs-6IS0fDFuSF4xo', 'num': 10 },
			function (data, textStatus, jqXHR) {  // success callback
				...
				html = '<a href="/roos/Documentation.nsf/json?searchView&SearchFuzzy=TRUE&Query=' + searchString5 + '"><div class="alert alert-info" role="alert">' + icon + 'Include Documentation in search results.</div></a>';
				html += '<div>';
